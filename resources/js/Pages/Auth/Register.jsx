    ...
    return (
        <div className="w-full h-screen flex items-center justify-center overflow-hidden relative">
            <Head>
                ...
                <title>Login</title>
            </Head>            <div className="w-full flex justify-center fixed top-6 z-[9999]">
                {flash.failled && (
            ...
            <form onSubmit={submit} className="w-full h-full">
                <div className="w-full h-full flex justify-center items-center ">
                    <div className="w-[345px] h-full relative  flex justify-center items-center">
                        <div
                            className="w-full border border-gray-400 rounded-lg px-6 py-8 bg-white transition-all ease-in-out duration-700 absolute left-0"
                            ref={form1Ref}
                        >
                            ...
                            <div className="mt-6 flex flex-col mb-6 transition-all ease-out">
                                <div className="mt-4">
                                    <InputLabel
                                        htmlFor="nama"
                                        value="Nama lengkap"
                                    ...
                                    <TextInput
                                        ...
                                        name="nama"
                                        value={data.nama}
                                        className="mt-1 block w-full rounded-xl text-sm text-gray-800"
                                        autoComplete="nama"
                                        isFocused={true}
                                        onChange={(e) =>
                            ...
                            <Button
                                onClick={(e) => {
                                    e.preventDefault();
                                    form1Ref.current.classList.add(
                                        "-translate-x-full"
                                    );
                                    form1Ref.current.classList.add("opacity-0");
                                    form2Ref.current.classList.add(
                                        "opacity-100"
                                    );
                                    form2Ref.current.classList.replace(
                                        "translate-x-full",
                                        "translate-x-0"
                                    );
                                    console.log(form2Ref.current);
                                }}
                                variant="contained"
                                sx={{
                                    backgroundColor:
                        ...
                        <div
                            className="w-full border border-gray-400 rounded-lg px-6 py-8 bg-white transition-all ease-in-out duration-500 translate-x-full absolute left-0 opacity-0"
                            ref={form2Ref}
                        >
                            <div className="flex flex-col">
                                <h1 className="text-2xl font-semibold">
                            ...
                            <div className="mt-6 flex flex-col mb-6 transition-all ease-out">
                                ...
                                <p className="text-xs font-medium text-gray-600 mt-1">
                                    Gunakan password unik, campuran huruf,
                                    angka, simbol; ubah secara rutin untuk
